  ...
  function processFile(path) {
       if (endsWith(path, ".zip")) {
	       ...
	       print(file_naked_nam);
				...
				TPX2_staining = "C3-"+file_naked_nam+".tif"; ///////////////////////////
				DNA_mask = "C4-"+file_naked_nam+".tif";
				Tubulin_mask = "C5-"+file_naked_nam+".tif";
				...
				saveAs("Results", outdir + file_naked_name + "_Spindle_Augmin.csv"); /////////////////////////////////////////// !!!!!!!!!!!!!!!!
