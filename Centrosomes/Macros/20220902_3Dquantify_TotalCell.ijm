root = "/Volumes/TOB_WD2/Microscopy/20210222_RNAi/KATNB1" + "/";
rawDir = root + "Crop_isotropic" + "/";
binaryDir = root + "Binary_Cell" + "/";

outDir = root + "Total_Cell_Katanin" + "/";
...
for (i = 0; i < fileList.length; i++) 
	...
	saveAs("Results", outDir + file_naked_name + "_Katanin_total.csv");
	run("Clear Results");
	run("Close All");
